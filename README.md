About localstack-plugin-loader
==============================
...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/localstack-plugin-loader-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14975&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/localstack-plugin-loader-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `localstack-plugin-loader` can be installed with:

```
conda install localstack-plugin-loader
```

It is possible to list all of the versions of `localstack-plugin-loader` available on your platform with:
